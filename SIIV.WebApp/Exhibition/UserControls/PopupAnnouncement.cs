...
// Type: SIIV.WebApp.Exhibition.UserControls.PopupAnnouncement
...
{
  public class PopupAnnouncement : Page
  {
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      this.lblMensaje.Text = string.Format(Convert.ToString(this.Request.QueryString["MessageText"], (IFormatProvider) CultureInfo.CurrentCulture), (object) "<br/>");
      if (int32 == 1)
