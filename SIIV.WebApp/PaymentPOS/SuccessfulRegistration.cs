...
// Type: SIIV.WebApp.PaymentPOS.SuccessfulRegistration
...
namespace SIIV.WebApp.PaymentPOS
{
  public class SuccessfulRegistration : Page
  {
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
      ...
      {
        this.oRequirementBL = new RequirementQueriesBL();
        if (this.oRequirementBL.GenerateProcessProductive(Convert.ToInt32(this.ViewState["intRequirementId"])) > 0)
        {
          SIIV.Common.Resource.Message.SetMessage(this.lblMessage, new HandledException(2, "***EXITO</br>Se ejecuto el proceso productivo y anaqueleo de la placa correctamente...!!"));
          this.Button2.Enabled = false;
        }
        else
        {
          SIIV.Common.Resource.Message.SetMessage(this.lblMessage, new HandledException(0, "***ERROR</br>No se pudo realizar el proceso...!!"));
          this.Button2.Enabled = false;
        }
      }
      catch (HandledException ex)
