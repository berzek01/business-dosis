...
// Type: SIIV.WebApp.Warehouse.Operations.PlateDeliveryItem
...
{
  public class PlateDeliveryItem : Page
  {
    ...
    protected Label lblFechaDenuncia;
    protected Fecha wdpDateDenuncia;
    protected TextBox wdpDateTimeDenuncia;
    protected Label lblNumeroParte;
    protected TextBox txtParte;
    protected Label lblClaveDenuncia;
    protected TextBox txtClaveDenuncia;
    ...
    protected HiddenField hddfTypeApplicant;
    protected HiddenField hddfNombreSolicitante;
    protected HiddenField hddfApplicantDocumentNumber;
    protected HiddenField hddfApplicantDocumentTypeId;
              ...
              case enmHavePlateOld.Si:
                switch (num1)
                {
                  ...
                  case 2:
                    ...
                    {
                      if (!checkBoxList.Items[1].Enabled && !checkBoxList.Items[2].Enabled && !checkBoxList.Items[3].Enabled)
                      {
                        checkBoxList.Items[1].Enabled = true;
                        checkBoxList.Items[2].Enabled = true;
                        checkBoxList.Items[3].Enabled = num3 == 14;
                      }
                      if (!checkBoxList.Items[0].Enabled && checkBoxList.Items[2].Enabled && checkBoxList.Items[3].Enabled)
                      {
                        checkBoxList.Items[0].Enabled = true;
                        checkBoxList.Items[2].Enabled = true;
                        checkBoxList.Items[3].Enabled = num3 == 14;
                    ...
                    if (checkBoxList.Items[1].Selected)
                    {
                      if (checkBoxList.Items[0].Enabled && checkBoxList.Items[2].Enabled && checkBoxList.Items[3].Enabled == (num3 == 14))
                      {
                        checkBoxList.Items[0].Enabled = false;
                        checkBoxList.Items[1].Selected = true;
                        if (Convert.ToInt32(this.hddfProcessTypeId.Value, (IFormatProvider) CultureInfo.CurrentCulture) == 1)
                        {
                          checkBoxList.Items[2].Selected = true;
                          checkBoxList.Items[2].Enabled = false;
                          this.lblTituloDatosDenuncia.Visible = true;
                          ...
                          this.txtDependency.Text = string.Empty;
                          this.txtDependency.Focus();
                          this.lblNumeroParte.Text = "Numero de orden: ";
                          this.lblFechaDenuncia.Text = "Fecha de denuncia: ";
                          this.wdpDateDenuncia.Visible = false;
                          this.wdpDateTimeDenuncia.Visible = true;
                          this.lblClaveDenuncia.Visible = true;
                          this.txtClaveDenuncia.Visible = true;
                          checkBoxList.Items[3].Enabled = false;
                        }
                      }
                    }
    ...
    protected void wibFinalize_Click(object sender, EventArgs e)
    {
      try
      {
        ...
        if (int32_1 == 1 && !this.chkVisa.Checked)
          throw new HandledException(1, "Datos de Intercambio: <br>__________________<br>Debe verificar la información");
        ...
        this.wdpDateTimeDenuncia.Text = this.Session["wdpDateTimeDenuncia"]?.ToString() ?? "";
      }
      catch (HandledException ex)
      {
        Message.SetMessage(this.lblMessage, ex);
    ...
    private void ShowPlateDeliverItem()
    {
      try
      {
        if (this.Request.QueryString["Ids"] != null)
        {
          ...
          int num2 = plateDeliverItemBy.Rows[0]["i_TypeApplicant"] != DBNull.Value ? (int) plateDeliverItemBy.Rows[0]["i_TypeApplicant"] : 0;
          int num3 = plateDeliverItemBy.Rows[0]["i_RegistrationReason"] != DBNull.Value ? (int) plateDeliverItemBy.Rows[0]["i_RegistrationReason"] : 0;
          int num4 = plateDeliverItemBy.Rows[0]["i_ApplicantDocumentTypeId"] != DBNull.Value ? (int) plateDeliverItemBy.Rows[0]["i_ApplicantDocumentTypeId"] : 0;
          ...
          this.wdpDateDenuncia.Value = plateDeliverItemBy.Rows[0]["d_DatePrintingPoliceReport"] != DBNull.Value ? Convert.ToDateTime(plateDeliverItemBy.Rows[0]["d_DatePrintingPoliceReport"]) : DateTime.MinValue;
          if (plateDeliverItemBy.Rows[0]["d_DatePrintingPoliceReport"] != DBNull.Value)
          {
            this.wdpDateTimeDenuncia.Text = Convert.ToDateTime(plateDeliverItemBy.Rows[0]["d_DatePrintingPoliceReport"]).ToString("yyyy-MM-dd");
            this.Session["wdpDateTimeDenuncia"] = (object) this.wdpDateTimeDenuncia.Text;
          }
          else
            this.wdpDateTimeDenuncia.Text = "";
          this.txtParte.Text = plateDeliverItemBy.Rows[0]["v_PoliceReportOrderNumber"].ToString();
          this.txtClaveDenuncia.Text = plateDeliverItemBy.Rows[0]["v_PoliceReportKey"].ToString();
          ...
          this.ViewState["vsCounterBlank"] = (object) num5;
          string str3 = plateDeliverItemBy.Rows[0]["v_UseCorrespondence"].ToString();
          this.LoadPersonDocumentType();
          if (intProcessTypeId == 1)
            this.wddDocumentDescription.SelectedValue = num4.ToString();
          ...
          if (0U > 0U)
          {
            int num6 = strArray4[strArray4.Length - 1].Trim() == "1" ? 1 : 2;
          }
          ...
          this.hddfTypeApplicant.Value = num2.ToString((IFormatProvider) CultureInfo.CurrentCulture);
          this.hddfApplicantDocumentTypeId.Value = num4.ToString((IFormatProvider) CultureInfo.CurrentCulture);
          this.hddfNombreSolicitante.Value = plateDeliverItemBy.Rows[0]["v_CompleteName"].ToString();
          this.hddfApplicantDocumentNumber.Value = plateDeliverItemBy.Rows[0]["v_ApplicantDocumentNumber"].ToString();
          if (!string.IsNullOrEmpty(pstrPlateOld))
          {
            if (intProcessTypeId == 2 || intProcessTypeId == 3 || intProcessTypeId == 5)
            {
            ...
            else if (intProcessTypeId == 1)
            {
              this.rblPersonTypeOwner.Enabled = false;
              this.rblPersonTypeOwner.Attributes.Remove("onclick");
              this.rblPersonTypeOwner.Style.Add("pointer-events", "none");
              this.rblTypeRecabante.Attributes.Remove("onclick");
              this.rblTypeRecabante.Style.Add("pointer-events", "none");
              this.rblcurrentOption.Attributes.Remove("onclick");
              this.rblcurrentOption.Style.Add("pointer-events", "none");
              this.rblPersonTypeCollect.Attributes.Remove("onclick");
              this.rblPersonTypeCollect.Style.Add("pointer-events", "none");
              this.rblPersonTypeOwner.SelectedValue = "1";
              this.rblPersonTypeOwner_SelectedIndexChanged((object) null, EventArgs.Empty);
              this.chkVisa.Visible = true;
              switch (num3)
              {
                case 1:
                  this.rblIsHavePlateOld.SelectedValue = "2";
                  this.rblIsHavePlateOld_SelectedIndexChanged((object) null, EventArgs.Empty);
                  this.rblIsHavePlateOld.Enabled = false;
                  this.rblIsHavePlateOld.Attributes.Remove("onclick");
                  this.rblIsHavePlateOld.Style.Add("pointer-events", "none");
                  this.chklRequisiteExchangeMode.SelectedIndex = 2;
                  this.chklRequisiteExchangeMode_SelectedIndexChanged((object) this.chklRequisiteExchangeMode, EventArgs.Empty);
                  this.chklRequisiteExchangeMode.Enabled = false;
                  this.chklRequisiteExchangeMode.Attributes.Remove("onclick");
                  this.chklRequisiteExchangeMode.Style.Add("pointer-events", "none");
                  this.wdpDateTimeDenuncia.Enabled = false;
                  this.txtParte.Enabled = false;
                  this.txtClaveDenuncia.Enabled = false;
                  break;
                case 2:
                  this.rblIsHavePlateOld.SelectedValue = "1";
                  this.rblIsHavePlateOld_SelectedIndexChanged((object) null, EventArgs.Empty);
                  this.rblIsHavePlateOld.Enabled = false;
                  this.rblIsHavePlateOld.Attributes.Remove("onclick");
                  this.rblIsHavePlateOld.Style.Add("pointer-events", "none");
                  this.chklRequisiteExchangeMode.SelectedIndex = num1 - 1;
                  this.chklRequisiteExchangeMode_SelectedIndexChanged((object) this.chklRequisiteExchangeMode, EventArgs.Empty);
                  this.chklRequisiteExchangeMode.Enabled = false;
                  this.chklRequisiteExchangeMode.Attributes.Remove("onclick");
                  this.chklRequisiteExchangeMode.Style.Add("pointer-events", "none");
                ...
                case 3:
                  ...
                  this.rblIsHavePlateOld.Attributes.Remove("onclick");
                  this.rblIsHavePlateOld.Style.Add("pointer-events", "none");
                  this.chklRequisiteExchangeMode.Items[1].Selected = true;
                  this.chklRequisiteExchangeMode.Items[2].Selected = true;
                  this.chklRequisiteExchangeMode_SelectedIndexChanged((object) this.chklRequisiteExchangeMode, EventArgs.Empty);
                  this.chklRequisiteExchangeMode.Enabled = false;
                  this.chklRequisiteExchangeMode.Attributes.Remove("onclick");
                  this.chklRequisiteExchangeMode.Style.Add("pointer-events", "none");
      ...
      float fltFuentePosY)
    {
      try
      {
        ...
        for (int index = 0; index < dt.Rows.Count; ++index)
        {
          ...
          ((System.Web.UI.WebControls.Image) this.dlProductComposition.Items[index].FindControl("ImgProductComposition")).ImageUrl = "~\\UserControls\\GetImageText.ashx?" + PlateDeliveryItem.getParameterRequest("imgDeliverPC", "110", " ", "", "", "", "30", "30", pstrPkImagen);
          if (index == 0)
            this.imgbtnPlateRecovery.ImageUrl = "~\\UserControls\\GetImageText.ashx?" + PlateDeliveryItem.getParameterRequest("imgDeliverPC", "110", strTitle, "Arial Black", "Black", "9", "30", "20", pstrPkImagen);
        }
      }
      catch (Exception ex)
      {
        ...
        if (this.txtTitle.Text.Contains("AAP"))
        {
          ...
          switch (intProcessTypeId)
          {
            ...
            case 6:
              ...
              this.imgbtnPlateRecovery.ImageUrl = "~\\UserControls\\GetImageText.ashx?" + PlateDeliveryItem.getParameterRequest("imgDeliverValid", "110", strPlateNew, "Arial Black", "Black", "9", "30", "20", pstrPkImagen);
              break;
          }
        }
    ...
    private void LoadInitial(enmOwnerPersonType pOwnerPersonType)
    {
      try
      {
        ...
        string str = this.hddfTypeApplicant.Value.ToString((IFormatProvider) CultureInfo.CurrentCulture);
        string pstrUseCorrespondence = this.hddfUseCorrespondence.Value.ToString((IFormatProvider) CultureInfo.CurrentCulture);
        switch (pOwnerPersonType)
        {
          case enmOwnerPersonType.Natural:
            ...
            if (int32 == 1)
            {
              this.rblTypeRecabante.SelectedValue = str;
              this.rblTypeRecabante.Enabled = false;
              this.rblcurrentOption.Enabled = false;
              this.wddOwner.Enabled = false;
              this.wddDocumentDescription.Enabled = false;
              this.txtNombresRecabante.Enabled = false;
              this.txtNumeroRecabante.Enabled = false;
              this.txtNotariaRecabante.Enabled = false;
              this.txtPartidaRecabante.Enabled = false;
            }
            switch ((enmTypeCollect) Convert.ToInt32(this.rblTypeRecabante.SelectedValue, (IFormatProvider) CultureInfo.CurrentCulture))
            {
              case enmTypeCollect.Propietario:
    ...
    private void LoadOwners()
    {
      try
      {
        string[] strArray1 = this.ViewState["vsOwnerDocumentNumber"] as string[];
        string[] strArray2 = this.ViewState["vsOwnerDocumentType"] as string[];
        string[] array = this.ViewState["vsOwners"] as string[];
        int int32 = Convert.ToInt32(this.hddfProcessTypeId.Value, (IFormatProvider) CultureInfo.CurrentCulture);
        Convert.ToInt32(this.hddfApplicantDocumentTypeId.Value, (IFormatProvider) CultureInfo.CurrentCulture);
        string str1 = this.hddfNombreSolicitante.Value.ToString();
        string str2 = this.hddfApplicantDocumentNumber.Value.ToString();
        if (int32 == 1)
        {
          Array.Resize<string>(ref array, array.Length + 1);
          array[array.Length - 1] = str1;
          this.txtNombresRecabante.Text = this.hddfNombreSolicitante.Value.ToString();
          this.wddDocumentDescription.Enabled = false;
          this.txtNotariaRecabante.Enabled = true;
        }
        this.wddOwner.DataSource = (object) array;
        this.wddOwner.DataBind();
        if (int32 != 2)
        {
          this.wddOwner.SelectedIndex = array.Length - 1;
          try
          {
          ...
          if (int32 == 1)
            this.txtNumeroRecabante.Text = str2;
          else
    ...
    private void RegisterDeliveryProcess()
    {
      try
      {
        ...
        }))
        {
          ...
          int int32_6 = Convert.ToInt32(this.hddfProcessTypeId.Value, (IFormatProvider) CultureInfo.CurrentCulture);
          if (this.divDatosDenuncia.Visible && int32_6 == 1)
            nullable6 = new DateTime?(Convert.ToDateTime(this.Session["wdpDateTimeDenuncia"].ToString(), (IFormatProvider) CultureInfo.CurrentCulture));
          if (this.ViewState["i_IsClaim"].ToString() == "0")
          {
            ...
            pobjPlateDeliverDataBE.d_ComplaintDate = nullable6;
            ...
            pobjPlateDeliverDataBE.v_PoliceReportKey = string.IsNullOrEmpty(this.txtClaveDenuncia.Text) ? (string) null : this.txtClaveDenuncia.Text;
            ...
            int int32_7 = Convert.ToInt32(this.hdiPlateTypeId.Value.ToString((IFormatProvider) CultureInfo.CurrentCulture));
            deliverManagementBl.PlateDeliverDataInsert(pobjPlateDeliverDataBE, int32_7);
          }
          else
    ...
    protected void wdpDateTimeDenuncia_TextChanged(object sender, EventArgs e)
    {
      this.Session["wdpDateTimeDenuncia"] = (object) this.wdpDateTimeDenuncia.Text;
    }
        ...
        switch ((enmHavePlateOld) Convert.ToInt32(this.rblIsHavePlateOld.SelectedValue, (IFormatProvider) CultureInfo.CurrentCulture))
        {
          case enmHavePlateOld.Si:
            ...
            if (this.chklRequisiteExchangeMode.Items[1].Selected && this.chklRequisiteExchangeMode.Items[2].Selected)
            {
              ...
              if (!this.chkVisa.Checked)
                throw new HandledException(1, "Datos de Intercambio: <br>_______________<br> Debe verificar la información");
            }
            if (this.chklRequisiteExchangeMode.Items[2].Selected && Convert.ToInt32(this.hddfProcessTypeId.Value, (IFormatProvider) CultureInfo.CurrentCulture) == 1)
            {
              if (this.txtDependency.Text == string.Empty)
                throw new HandledException(1, "Datos de Denuncia: <br>_______________<br> Debe ingresar una dependencia válida.");
              if (this.txtParte.Text == string.Empty)
          ...
          case enmHavePlateOld.No:
            ...
            if (Convert.ToInt32(this.hddfProcessTypeId.Value, (IFormatProvider) CultureInfo.CurrentCulture) == 1 && !this.chkVisa.Checked)
              throw new HandledException(1, "Datos de Intercambio: <br>_______________<br> Debe verificar la información");
            break;
        }
      }
