...
// Type: SIIV.WebApp.Warehouse.Rpt.ReportKardexVal
...
{
  [Serializable]
  public class ReportKardexVal : ReportClass
  {
    public override string ResourceName
    {
      get => "ReportKardexVal.rpt";
      set
      {
      }
    }
    ...
    {
      get => "SIIV.WebApp.Warehouse.Rpt.ReportKardexVal.rpt";
      set
      {
      }
    }
