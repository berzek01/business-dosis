...
// Type: SIIV.WebApp.Warehouse.Rpt.ProductStockReportDesechoAAP
...
{
  [Serializable]
  public class ProductStockReportDesechoAAP : ReportClass
  {
    public override string ResourceName
    {
      get => "ProductStockReportDesechoAAP.rpt";
      set
      {
      }
    }
    ...
    {
      get => "SIIV.WebApp.Warehouse.Rpt.ProductStockReportDesechoAAP.rpt";
      set
      {
      }
    }
