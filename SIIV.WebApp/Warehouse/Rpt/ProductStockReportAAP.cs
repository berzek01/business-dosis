...
// Type: SIIV.WebApp.Warehouse.Rpt.ProductStockReportAAP
...
{
  [Serializable]
  public class ProductStockReportAAP : ReportClass
  {
    public override string ResourceName
    {
      get => "ProductStockReportAAP.rpt";
      set
      {
      }
    }
    ...
    {
      get => "SIIV.WebApp.Warehouse.Rpt.ProductStockReportAAP.rpt";
      set
      {
      }
    }
    ...
    [Browsable(false)]
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    public IParameterField Parameter_i_ShelfId
    {
