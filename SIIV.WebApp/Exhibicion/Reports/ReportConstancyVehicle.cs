...
// Type: SIIV.WebApp.Exhibicion.Reports.ReportConstancyVehicle
...
{
  public class ReportConstancyVehicle : ReportClass
  {
    public override string ResourceName
    {
      get => "ReportConstancyVehicle.rpt";
      set
      {
      }
    }
    ...
    {
      get => "SIIV.WebApp.Exhibicion.Reports.ReportConstancyVehicle.rpt";
      set
      {
      }
    }
