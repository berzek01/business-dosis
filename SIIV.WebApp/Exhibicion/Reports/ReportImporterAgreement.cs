...
// Type: SIIV.WebApp.Exhibicion.Reports.ReportImporterAgreement
...
{
  public class ReportImporterAgreement : ReportClass
  {
    public override string ResourceName
    {
      get => "ReportImporterAgreement.rpt";
      set
      {
      }
    }
    ...
    {
      get => "SIIV.WebApp.Exhibicion.Reports.ReportImporterAgreement.rpt";
      set
      {
      }
    }
