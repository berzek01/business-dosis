...
// Type: SIIV.WebApp.Exhibicion.Reports.ReportAssociatedAgreementRotate
...
{
  public class ReportAssociatedAgreementRotate : ReportClass
  {
    public override string ResourceName
    {
      get => "ReportAssociatedAgreementRotate.rpt";
      set
      {
      }
    }
    ...
    {
      get => "SIIV.WebApp.Exhibicion.Reports.ReportAssociatedAgreementRotate.rpt";
      set
      {
      }
    }
