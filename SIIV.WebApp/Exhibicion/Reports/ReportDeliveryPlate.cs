...
// Type: SIIV.WebApp.Exhibicion.Reports.ReportDeliveryPlate
...
{
  public class ReportDeliveryPlate : ReportClass
  {
    public override string ResourceName
    {
      get => "ReportDeliveryPlate.rpt";
      set
      {
      }
    }
    ...
    {
      get => "SIIV.WebApp.Exhibicion.Reports.ReportDeliveryPlate.rpt";
      set
      {
      }
    }
