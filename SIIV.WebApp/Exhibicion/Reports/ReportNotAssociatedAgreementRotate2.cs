...
// Type: SIIV.WebApp.Exhibicion.Reports.ReportNotAssociatedAgreementRotate2
...
{
  public class ReportNotAssociatedAgreementRotate2 : ReportClass
  {
    public override string ResourceName
    {
      get => "ReportNotAssociatedAgreementRotate2.rpt";
      set
      {
      }
    }
    ...
    {
      get => "SIIV.WebApp.Exhibicion.Reports.ReportNotAssociatedAgreementRotate2.rpt";
      set
      {
      }
    }
