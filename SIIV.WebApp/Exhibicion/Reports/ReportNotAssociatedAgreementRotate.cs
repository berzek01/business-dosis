...
// Type: SIIV.WebApp.Exhibicion.Reports.ReportNotAssociatedAgreementRotate
...
{
  public class ReportNotAssociatedAgreementRotate : ReportClass
  {
    public override string ResourceName
    {
      get => "ReportNotAssociatedAgreementRotate.rpt";
      set
      {
      }
    }
    ...
    {
      get => "SIIV.WebApp.Exhibicion.Reports.ReportNotAssociatedAgreementRotate.rpt";
      set
      {
      }
    }
