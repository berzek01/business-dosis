...
// Type: SIIV.WebApp.Exhibicion.Reports.ReportDeliveryPlateExhibition
...
{
  public class ReportDeliveryPlateExhibition : ReportClass
  {
    public override string ResourceName
    {
      get => "ReportDeliveryPlateExhibition.rpt";
      set
      {
      }
    }
    ...
    {
      get => "SIIV.WebApp.Exhibicion.Reports.ReportDeliveryPlateExhibition.rpt";
      set
      {
      }
    }
