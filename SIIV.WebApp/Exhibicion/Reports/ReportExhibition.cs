...
// Type: SIIV.WebApp.Exhibicion.Reports.ReportExhibition
...
{
  public class ReportExhibition : ReportClass
  {
    public override string ResourceName
    {
      get => "ReportExhibition.rpt";
      set
      {
      }
    }
    ...
    {
      get => "SIIV.WebApp.Exhibicion.Reports.ReportExhibition.rpt";
      set
      {
      }
    }
