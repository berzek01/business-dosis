...
// Type: SIIV.WebApp.Exhibicion.Reports.ReportVehicularMovement
...
{
  public class ReportVehicularMovement : ReportClass
  {
    public override string ResourceName
    {
      get => "ReportVehicularMovement.rpt";
      set
      {
      }
    }
    ...
    {
      get => "SIIV.WebApp.Exhibicion.Reports.ReportVehicularMovement.rpt";
      set
      {
      }
    }
