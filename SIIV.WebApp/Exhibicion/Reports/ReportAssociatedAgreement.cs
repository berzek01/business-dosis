...
// Type: SIIV.WebApp.Exhibicion.Reports.ReportAssociatedAgreement
...
{
  public class ReportAssociatedAgreement : ReportClass
  {
    public override string ResourceName
    {
      get => "ReportAssociatedAgreement.rpt";
      set
      {
      }
    }
    ...
    {
      get => "SIIV.WebApp.Exhibicion.Reports.ReportAssociatedAgreement.rpt";
      set
      {
      }
    }
    ...
    public Section ReportHeaderSection2 => this.ReportDefinition.Sections[0];
