...
// Type: SIIV.WebApp.Exhibicion.Reports.ReportImporterAgreementRotate
...
{
  public class ReportImporterAgreementRotate : ReportClass
  {
    public override string ResourceName
    {
      get => "ReportImporterAgreementRotate.rpt";
      set
      {
      }
    }
    ...
    {
      get => "SIIV.WebApp.Exhibicion.Reports.ReportImporterAgreementRotate.rpt";
      set
      {
      }
    }
