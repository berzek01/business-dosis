...
// Type: SIIV.WebApp.Retail.CashRegister.ReportCashReg
...
{
  public class ReportCashReg : ReportClass
  {
    public override string ResourceName
    {
      get => "ReportCashReg.rpt";
      set
      {
      }
    }
    ...
    {
      get => "SIIV.WebApp.Retail.CashRegister.ReportCashReg.rpt";
      set
      {
      }
    }
